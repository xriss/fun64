...
#dire Conversation with someone godawful

	Some sort of description about this dire conversation here. It can 
	contain any number or words or paragraphs if you are of the 
	verbally diaorrhea-tic inclined.
	
- This is the first thing the NPC says to you.
<welcome

	Hey! Hey... hey wait a minute! Yeah, I'm talking to you. Sheesh.
	...
	>meh
		...
		Stop and listen, whilst frowning really hard.
		
	>yay
	
		Oh god, sorry! I.. I didn't know you were there. Is everything ok?
		
<nay

	Wow. Some people are rude. Fine, whatever. No, wait. Hang on.
	
	>nay1
	
		Just keep walking away - briskly this time, head down.
		
	>nay2
	
		Stop, turn and observe. It seems the person looks really desperate.
		
	>welcome
	
		Slow down but pretend you've just received a phonecall.
		
<meh

	OK. Wow, sorry - thanks for stopping. Look, I'm in a bit of a 
	quandry here. My friend, over there (points off screen) is 
	really... ok look, I'm going to be honest with you because you 
	know, I'm an honest person and I don't want to waste your time. 
	He's cold and hungry but that doesn't even matter.
	
	The thing is, it would really help him if he had something to warm 
	him up - you know, what I mean? Just a bob or two would help. He's 
	not asking for much. I mean, he's not even doing the asking. I am - 
	on his behalf. He doesn't even want to ask. He's just stting there 
	shivering and I have none to spare so I thought I'd do it on his 
	behalf. Could you? A little bit helps.
...
- The welcome chunk is a special name, much like body in html. Do not change it.
...
update=function()
	...
	if not setup_done then
		chats=setup_chats(chat_text)
		menu=setup_menu( chats.get_menu_items("dire") )
		setup_done=true
	end
